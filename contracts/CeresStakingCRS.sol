...
contract CeresStakingCRS is CeresStakingRewards, IMintReceiver, UUPSUpgradeable {
    ...
    function stake(uint256 amount) public override nonReentrant updateReward(msg.sender) updateMint(msg.sender) {
        ...
        crs.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 shareAmount) public override nonReentrant updateReward(msg.sender) updateMint(msg.sender) {
        ...
        require(ICeresBank(factory.ceresBank()).ascPriceAnchored(), "CeresStaking: Can not withdraw under anchor price!");
        ...
        crs.transfer(msg.sender, withdrawAmount);
