...
contract StakingASC is Staking, IRedeemer {
    ...
    function redeemEarnedBUSD(address account) public view returns (uint256) {
        ...
        / SHARE_PRECISION + redeemsBUSD[account];
    }
    ...
    function notifyRedeem(uint256 ascAmount, uint256 crsAmount, uint256 busdAmount) public override onlyPools {
        ...
        if (busdAmount > 0) {
            ...
            redeemPerShareStoredBUSD += busdAmount * SHARE_PRECISION / _totalShare;
        }
    ...
    function stakeWithReferral(uint256 amount, address referral) external nonReentrant whenNotPaused updateReward(msg.sender) updateRedeem(msg.sender) {
        ...
        uint256 stakeAmount = _transferWithReferral(coinASC, amount, referral);
    ...
    function reinvestRedeem() public override nonReentrant updateRedeem(msg.sender) {
        ...
        if (redeemBUSD > 0) {
            ...
            address stakingBUSD = stakingAddresses[busdAddress];
